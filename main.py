...
parser.add_argument('--loss', default='cross', help='Which loss function to use (mse or cross, default: mse)')
...
parser.add_argument('--batchsize', type=int, default=156, help='Batch size to split dataset, default: 64')
